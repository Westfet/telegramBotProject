...
class ReplyKeyboardMarkup(base.TelegramObject):
    """
    This object represents a custom keyboards with reply options
...
class ReplyKeyboardRemove(base.TelegramObject):
    """
    Upon receiving a message with this object, Telegram clients will remove the current custom keyboards
    and display the default letter-keyboards. By default, custom keyboards are displayed until a new keyboards is sent by a bot.
